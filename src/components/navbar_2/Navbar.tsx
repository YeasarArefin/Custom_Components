...
export default function Navbar() {
    ...
    return (
        <div className="sticky top-0 mb-5">
            ...
            <div className={cn("", { "bg-black/50 md:hidden z-30 fixed top-0 left-0 backdrop-blur-sm transition-all duration-[700ms] h-[100%] w-full": mobileMenu })} onClick={() => setMobileMenu(false)}>
                <div className={cn("flex flex-col w-[300px] h-[100%] md:hidden gap-y-5 pt-5 container top-0 left-0 fixed bg-white transition-all duration-200 ease-in-out", { "-left-[500px]": !mobileMenu, "-left-[0px]": mobileMenu })}>
